    ...
    "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                ...
                coral:
                    "bg-coral-500 text-white hover:bg-coral-600 shadow-lg shadow-coral-500/25 hover:shadow-xl hover:shadow-coral-500/30 hover:-translate-y-0.5",
                joy:
                    "bg-gradient-joy text-white hover:opacity-90 shadow-lg shadow-joy-500/25 hover:shadow-xl hover:shadow-joy-500/30 hover:-translate-y-0.5",
            },
            size: {
...
export interface ButtonProps
    ...
    asChild?: boolean;
    variant?: "default" | "destructive" | "outline" | "secondary" | "ghost" | "link" | "coral" | "joy";
